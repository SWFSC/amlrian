...
#' @param Server character; default is 'swc-***REMOVED***-s'. See \code{\link[pool]{dbPool}}
...
#'
#' @export
amlr_pinnipeds_dbPool <- function(Database, Driver = "SQL Server", Server = "swc-***REMOVED***-s",
                                  idleTimeout = 3600000, ...) {
  try(pool::dbPool(
    drv = odbc::odbc(),
    Driver = Driver,
